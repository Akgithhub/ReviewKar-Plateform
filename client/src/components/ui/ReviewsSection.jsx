...
const ReviewCard = ({ name, text, reply }) => (
  <div className="bg-white p-4 rounded shadow-sm mb-6">
    ...
    <div className="flex items-center gap-3 text-sm text-gray-500">
      <button className="border px-2 py-1 rounded hover:bg-gray-100">👍 Useful</button>
      <button className="border px-2 py-1 rounded hover:bg-gray-100">👎 Not useful</button>
...
const CompanyInfo = () => (
  <div className="bg-white p-4 shadow-sm rounded">
    ...
    <div className="text-sm text-gray-600 mb-1">
      ...
      9785 Baker st. 567<br />
      Los Angeles - US
    </div>
    <div className="text-sm text-gray-600 mb-1">
      <strong>Website:</strong><br />
      <a href="#" className="text-blue-600">goodelectronics.com</a>
    </div>
    <div className="text-sm text-gray-600 mb-1">
      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          ...
          <ReviewCard
            name="Monika"
            text="Eos tollit ancillae ea, lorem consulatu qui ne..."
            reply="Hi Monika, thanks again for your kind feedback..."
          />
          <ReviewCard
            name="Lukas"
            text="Repetitive example of a great experience shared by Lukas..."
          />
          <Pagination />
        </div>
        <CompanyInfo />
